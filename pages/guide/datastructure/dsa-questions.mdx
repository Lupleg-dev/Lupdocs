...
- 	The isEmpty method checks if the stack is empty.
  ...
  # Question 2: Binary Search in a Sorted Array
...
# Question 3: Implementing a Queue using Linked List
...
```
 ...
 # Question 4: Finding the Middle of a Linked List
...
# Question 5: Implementing Merge Sort
