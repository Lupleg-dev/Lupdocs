...
Lupleg handles the hard work of creating and managing subscriptions in your application, but you will need to create a [Stripe account](https://dashboard.stripe.com/register) and configure a few settings before you can start processing payments and start making some sweet dollas.
